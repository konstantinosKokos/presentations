...
\quad\light{Horizontal Movement}}\smaller
	...
	\alt<2>{
		\[
		\infer*{
			((\struct[\ddet]{\markproofleaf{n1}{\w{the}}} \cdot \w{\markproofleaf{n2}{violence}}) \cdot \struct[\dmod]{(\markproofleaf{n3}{\w{that}} \cdot \struct[\body]{(\struct[\su]{(\struct[\ddet]{\markproofleaf{n4}{\w{the}}} \cdot \markproofleaf{n5}{\w{world}})} \cdot (\markproofleaf{n6}{\w{ignores}} \cdot \struct[\dmod]{\markproofleaf{n7}{\w{happily}}}))})})
		}{}
		\]
	}{
	that :: \sout{$\ty{(n \bs n) / (s / np )}$} \ \sout{$\ty{(n \bs n) / (s / \ddia\dbox np )}$} $\ty{(\dxbox[\dmod](n \bs n) / \dxdia[\body](s / \alert{\ddia\dbox}\dxdia[\su] np))}$
	\vfill
	\smaller
	...
	\[
		\infer[\dxbox_E]{\struct[\dmod]{(\w{that} \cdot \struct[\body]{(\struct[\su]{(\struct[\ddet]{\w{the}} \cdot \w{world})} \cdot (\w{ignores} \cdot \struct[\dmod]{\w{happily}}))})} \vdash n \bs n}{
			\infer[/_E]{(\w{that} \cdot \struct[\body]{(\struct[\su]{(\struct[\ddet]{\w{the}} \cdot \w{world})} \cdot (\w{ignores} \cdot \struct[\dmod]{\w{happily}}))}) \vdash \ty{\dxbox[\dmod](n \bs n)}}{
				\infer[\Lex]{\dots}{\w{that}} 
%				\ty{(\dxbox[\dmod](n \bs n) / \dxdia[\body](s / \ddia\dbox\dxdia[\su] np))}}
				&
				\hspace{-4.5em}
				\infer[\dxdia_I]{\struct[\body]{(\struct[\su]{(\struct[\ddet]{\w{the}} \cdot \w{world})} \cdot (\w{ignores} \cdot \struct[\dmod]{\w{happily}}))} \vdash \ty{\dxdia[\body](s / \ddia \dbox\dxdia[\su] np)}}{
					\infer[/_I]{(\struct[\su]{(\struct[\ddet]{\w{the}} \cdot \w{world})} \cdot (\w{ignores} \cdot \struct[\dmod]{\w{happily}})) \vdash \ty{s / \ddia \dbox\dxdia[\su] np}}{
						\infer[\ddia_E]{((\struct[\su]{(\struct[\ddet]{\w{the}} \cdot \w{world})} \cdot (\w{ignores} \cdot \struct[\dmod]{\w{happily}}))\cdot\ty{\ddia\dbox\dxdia[\su]np}) \vdash \ty{s}}{
							\infer[\Ax]{\ty{\ddia\dbox\dxdia[\su] np} \vdash \ty{\ddia\dbox\dxdia[\su] np}}{}
							&
							\hspace{-8em}
							\infer[A^r_{\ddia}]{((\struct[\su]{(\struct[\ddet]{\w{the}} \cdot \w{world})} \cdot (\w{ignores} \cdot \struct[\dmod]{\w{happily}}))\cdot\struct{\ty{\dbox\dxdia[\su] np}}) \vdash \ty{s}}{
								\infer[C^r_{\ddia}]{(\struct[\su]{(\struct[\ddet]{\w{the}} \cdot \w{world})} \cdot ((\w{ignores} \cdot \struct[\dmod]{\w{happily}})\cdot\struct{\ty{\dbox\dxdia[\su] np}})) \vdash \ty{s}}{
									\infer[\bs_E]{(\struct[\su]{(\struct[\ddet]{\w{the}} \cdot \w{world})} \cdot ((\w{ignores} \cdot \struct{\ty{\dbox\dxdia[\su] np}})\cdot\struct[\dmod]{\w{happily}}))  \vdash \ty{s}}{
										...
										&
%										\hspace{-3em}
										\infer[\bs_E]{((\w{ignores} \cdot \struct{\ty{\dbox\dxdia[\su] np}})\cdot\struct[\dmod]{\w{happily}}) \vdash \ty{\dxdia[\su]np \bs s}}{
