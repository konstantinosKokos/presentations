...
\begin{frame}{Ducks, Proven}
	...
	\infer[E]{
		...
		\infer[\hspace{-3pt}E]{
			...
			\hspace{-10pt}
			\infer[\hspace{-3pt}I]{
				\text{sierlijk zwemmen} \vdash 
				\diamond^{subj} NP \multimap S}{
					\infer[\hspace{-3pt}E]{
						\diamond^{subj}NP, \text{sierlijk zwemmen} \vdash
						S
					}{
						\infer[\hspace{-3pt}E]{
\diamond^{subj}NP, \text{zwemmen} \vdash
							S}{
							\infer[\hspace{-3pt}Ax]{
								\diamond^{subj}NP \vdash \diamond^{subj}NP}{}
							&
							\infer[\hspace{-3pt}Ax]{\diamond^{subj}NP \multimap S}{\text{\textit{zwemmen}}}
						}
						&
						\infer[\hspace{-3pt}Ax]{
